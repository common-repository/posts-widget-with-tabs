...
// Widget settings form
    function form($instance)
    {
        ...
        for ($i = 1; $i <= $count_tabs; $i++):
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id('title_tab' . $i . ' :'); ?>"><?php _e('Tab ' . $i . ' Title:'); ?></label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id('content_type_tab' . $i); ?>"><?php _e('Choose the Content Type to display :'); ?></label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id('category_tab' . $i); ?>"><?php _e('Choose the Category to display :'); ?></label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id('order_tab' . $i); ?>"><?php _e('Order Posts by :'); ?></label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id('orderby_tab' . $i); ?>"><?php _e('Order Posts by fields :'); ?></label>
                <select name="<?php echo $this->get_field_name('orderby_tab' . $i); ?>"
                    ...
                    <option
                        id="post_author" <?php selected($orderby_tab[$i], 'author'); ?>><?php _e('author'); ?></option>
                    ...
                    <option
                        id="post_modified" <?php selected($orderby_tab[$i], 'modified'); ?>><?php _e('modified'); ?></option>
                    <option id="post_rand" <?php selected($orderby_tab[$i], 'rand'); ?>><?php _e('rand'); ?></option>
                    <option
                        id="post_comment" <?php selected($orderby_tab[$i], 'comment_count'); ?>><?php _e('comment_count'); ?></option>
                </select>
            </p>
            <p>
                ...
                <label
                    for="<?php echo $this->get_field_id('show_image_tab' . $i); ?>"><?php _e('Display featured images?'); ?></label>
            </p>
            <p>
                <label
                    for="<?php echo $this->get_field_id('number_tab' . $i); ?>"><?php _e('Number of posts to show :'); ?></label>
